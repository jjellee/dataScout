...
title: "Zebra Technologies Corporation Q1 2026 Earnings Call Transcript"
published: 2026-05-12
quarter: "Q1 2026"
event_id: 419046
source: stockanalysis
source_url: https://stockanalysis.com/stocks/zbra/transcripts/419046-q1-2026/
audio_url: https://files.quartr.com/audio-files/f2ee7-2026-05-12-13-38-37.mpeg?ref=U0E=
---

# Zebra Technologies Corporation — Q1 2026 (2026-05-12)

## 요약(stockanalysis 자동 생성)

### Executive summary

- Achieved strong Q1 results with sales near $1.5 billion, up 14% year-over-year (4% organic), and raised full-year outlook due to continued business momentum and robust demand trends.
- Integrated portfolio of hardware, software, and services drives industry leadership and customer productivity, with increasing adoption of automation and AI.
- Strategic priorities focus on profitable growth, innovation, and financial strength, supported by disciplined capital allocation and efficiency initiatives.


### Financial highlights

- Q1 adjusted EBITDA margin reached 23.2%, up 90 basis points year-over-year, with non-GAAP diluted EPS of $4.75, an 18% increase.
- Adjusted gross margin improved 80 basis points to 50.4%, driven by productivity initiatives and favorable business mix.
- Free cash flow for Q1 was $163 million; debt leverage ratio at 2.1 with $1.1 billion in credit capacity.


### Outlook and guidance

- Full-year sales growth expected between 10% and 14%, with a one-point increase at the midpoint from prior outlook.
- Full-year adjusted EBITDA margin projected at approximately 22%; non-GAAP diluted EPS expected between $18.30 and $18.70.
- Free cash flow for the year anticipated to be at least $900 million, with a conversion rate of about 100%.
- Q2 adjusted EBITDA margin expected slightly above 21%, with EPS guidance of $4.20–$4.50.


### Segment performance

- Connected Frontline segment grew 20.6% (3.8% organic), led by mobile computing and supported by Elo Touch acquisition.
- Asset Visibility and Automation segment grew 4.8%, driven by printing and Machine Vision.
- All regions posted growth: North America +4%, EMEA +2%, Asia Pacific +11%, Latin America +10%.
- Machine Vision saw strong double-digit growth; RFID pipeline remains robust with expected growth resuming after Q1.


### Key financial ratios and metrics

- Adjusted EBITDA margin: 23.2% in Q1, up 90 bps year-over-year.
- Adjusted gross margin: 50.4%, up 80 bps year-over-year.
- Debt leverage ratio: 2.1.
- Free cash flow: $163 million in Q1; full-year target at least $900 million.


### Risk factors and uncertainties

- Memory supply and cost inflation remain key risks, but mitigation strategies and supplier relationships provide confidence in meeting guidance.
- Freight costs have increased 20–30% but are incorporated into guidance and remain manageable.
- Tariff regime changes expected to have minimal impact on full-year results.


### Significant events and developments

- $500 million in share repurchases executed year-to-date through early May, exceeding 50% of free cash flow.
- Elo Touch acquisition contributed to segment growth and expanded geographic reach, with synergy realization progressing as planned.
- Continued investment in AI, Machine Vision, and RFID to drive differentiation and growth.


### Capital allocation and financing

- Capital allocation prioritizes business investment and consistent shareholder returns, with flexibility to allocate all free cash flow to share repurchases if attractive.
- $300 million in stock repurchases in Q1, plus $200 million in Q2 to date.


### Market and industry conditions

- Durable demand drivers include automation, digitization, and AI adoption across a $35 billion served market.
- Customers face labor constraints, cost pressures, and rising expectations for real-time visibility, supporting long-term growth.
- Broad-based growth across verticals and geographies, with manufacturing, retail, e-commerce, and healthcare showing particular strength.
...
Only thing I'd add is if you really look at the Q1, you know, the upside to our guidance to the high end was driven by Asset Visibility, and the strength in manufacturing, which did not have the price increase. The real strength in the quarter, which drove some of the gross margin favorability, was around Asset Visibility, which is again, where we didn't have the price increase to just, you know, add to what Bill had mentioned. The other one, we did incorporate the full year pricing benefit of a point into our guide. We offset that by lower volume assumptions in the back half due to the memory constraints. If you look at it kind of net neutral from the benefit on the pricing side, but then lowering the overall demand or volume given the constraints. That balances out for the second half of the year.
...
Kind of tagging on that last question. You raised the full year organic growth guidance by about one point to 5%. You mentioned the Q1 outperformance in manufacturing in Latin America and Asia. Curious if you could elaborate a bit more on what drove the implicit organic growth guidance range for the rest of the year, whether that's by vertical or by geography.

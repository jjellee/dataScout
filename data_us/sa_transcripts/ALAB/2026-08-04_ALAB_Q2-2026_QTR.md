...
title: "Astera Labs, Inc. Q2 2026 Earnings Call Transcript"
published: 2026-08-04
quarter: "Q2 2026"
event_id: 660931
source: stockanalysis
source_url: https://stockanalysis.com/stocks/alab/transcripts/660931-q2-2026/
audio_url: https://files.quartr.com/audio-files/c856bbdadcd57509bd508c9319782801-2026-08-04-21-35-36.mpeg?ref=U0E=
---

# Astera Labs, Inc. — Q2 2026 (2026-08-04)

## 요약(stockanalysis 자동 생성)

### Executive summary

- Achieved record Q2 revenue of $392.4 million, up 27% sequentially and 104% year-over-year, driven by broad-based strength across all product lines, especially AI fabric and signal conditioning portfolios.
- Scorpio X-Series high-radix AI fabric switches entered volume production, expected to become the largest product family by revenue in Q3, one quarter ahead of prior expectations.
- Strong customer traction with over 10 customers engaged on Scorpio X, including hyperscalers, neo-clouds, and enterprise deployments across both liquid- and air-cooled servers.
- Continued expansion and diversification of the product portfolio, including Aries (signal conditioning), Taurus (smart cable modules), and Leo (CXL memory controllers), with robust design win momentum.
- Strategic investments in optical connectivity and custom silicon solutions, positioning for multi-billion dollar incremental opportunities in 2027 and beyond.


### Financial highlights

- Q2 revenue reached $392.4 million, up 27% sequentially and 104% year-over-year.
- Non-GAAP gross margin was 73.7%, above guidance; non-GAAP operating margin was 39.1%, up 290 basis points from Q1.
- Non-GAAP net income was $145.8 million, with diluted EPS of $0.80, up over 30% from Q1.
- Cash, cash equivalents, and marketable securities totaled $1.25 billion at quarter end.


### Outlook and guidance

- Q3 revenue expected between $540 million and $560 million, representing 40% sequential growth at the midpoint.
- Q3 non-GAAP gross margin expected at ~72%; operating margin at ~43%, up 400 basis points sequentially.
- Q3 non-GAAP diluted EPS expected between $1.16 and $1.21.
- Scorpio X-Series anticipated to become the largest product line by revenue in Q3.


### Segment performance

- PCIe 6.0 products represented over 50% of total Q2 revenue, up from one-third in Q1.
- Aries signal conditioning delivered record revenue, driven by strong adoption in both scale-up and scale-out AI platforms.
- Taurus revenue grew strongly, with pre-production ramp for 100G per lane modules supporting 800G Ethernet.
- Leo CXL memory controllers secured new design wins with U.S. hyperscalers, with volume shipments expected in 2027.


### Key financial ratios and metrics

- Q2 non-GAAP gross margin: 73.7%.
- Q2 non-GAAP operating margin: 39.1%.
- Q2 non-GAAP tax rate: 12%.
- Q2 non-GAAP diluted EPS: $0.80.
- Q3 guidance: gross margin ~72%, operating margin ~43%, diluted EPS $1.16–$1.21.


### Risk factors and uncertainties

- Forward-looking statements are subject to risks and uncertainties, including market adoption, customer demand, and execution on new product ramps.
- Actual results may differ materially due to factors discussed in SEC filings.


### Significant events and developments

- Scorpio X-Series entered volume production, accelerating the transition to AI fabric leadership.
- Expansion into optical connectivity with aiXscale acquisition, targeting high-density fiber-attached and co-packaged optics solutions for 2027 and beyond.
- Custom silicon solutions for hybrid rack architectures and specialized memory controllers to ship in 2027.
- COSMOS software platform now enables advanced orchestration and in-network compute, increasing customer stickiness.


### Capital allocation and financing

- Continued strategic investment in R&D and product roadmap while maintaining strong profitability.
- Cash and equivalents at $1.25 billion, supporting ongoing growth initiatives.


### Market and industry conditions

- AI infrastructure investment accelerating globally, with hyperscaler and sovereign AI spending projected to reach trillion-dollar levels by 2027.
- Rapid adoption of PCIe 6.0, UALink, and CXL protocols driving increased silicon content per XPU.
- Optical connectivity and custom solutions expanding total addressable market into tens of billions of dollars.
...
Your next question comes from the line of Blayne Curtis with Jefferies. Blayne, your line is now open. Please go ahead.
...
By the way, we expect this trend to continue as new Gen 6 platforms and GPUs are being developed. This is not a trend that will stop. Then, of course, then we move on to Gen 7. You can expect some of this cycle to continue for a long time.
...
Your next question comes from the line of Natalia Winkler with UBS. Natalia, your line is open. Please go ahead.
...
Your next question comes from the line of Sean O'Loughlin with TD Cowen. Sean, your line is now open. Please go ahead.
...
Our next question comes from Karl Ackerman with BNP Paribas. Karl, your line is now open. Please go ahead.

**Karl Ackerman**  
*Analyst / BNP Paribas*

Yes, thank you. Jitendra, Scorpio X is ramping significantly in the second half of this year, largely driven by the product transition at your main customer. Could you discuss the breadth of customer wins, including a growing mix of neo clouds, and whether your Scorpio X opportunity extends across both liquid-cooled and air-cooled servers? Thank you.
...
Also maybe to add one more point that is somewhat lost is even with the lead hyperscaler we have, there are multiple platforms where we are designed in. It's not like there is just one, right? I think that's a nuance that needs to be considered as you look at our business.

**Operator**

There are no further questions at this time. I will now turn the call back over to Leslie Green for closing remarks.

**Leslie Green**  
*Investor Relations / Astera Labs*

Thank you , everyone, for your participation and questions. Please refer to our investor relations website for information regarding upcoming financial conferences and events. Thanks so much.

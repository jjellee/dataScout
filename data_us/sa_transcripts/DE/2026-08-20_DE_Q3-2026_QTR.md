...
title: "Deere & Company Q3 2026 Earnings Call Transcript"
published: 2026-08-20
quarter: "Q3 2026"
event_id: 564523
source: stockanalysis
source_url: https://stockanalysis.com/stocks/de/transcripts/564523-q3-2026/
audio_url: https://files.quartr.com/audio-files/1cf02b4c6ad9ca65e3ba46ed8b1196a7-2026-08-20-15-09-06.mpeg?ref=U0E=
---

# Deere & Company — Q3 2026 (2026-08-20)

## 요약(stockanalysis 자동 생성)

### Executive summary

- Achieved strong Q3 results with equipment operations operating margin at 14.4% and net sales up 6% year-over-year, driven by disciplined execution and favorable price realization.
- Net income for the quarter was $1.379 billion ($5.10 per diluted share), with continued progress in inventory health and cost management.
- Diversified portfolio supported performance amid varying market conditions, with Construction & Forestry and Small Ag & Turf segments showing robust growth.


### Financial highlights

- Q3 net sales and revenues rose 5% to $12.608 billion; equipment operations net sales up 6% to $10.999 billion.
- Net income attributable to the company was $1.379 billion for Q3.
- Production & Precision Ag net sales down 6% year-over-year to $3.998 billion; Small Ag & Turf net sales up 12% to $3.383 billion; Construction & Forestry net sales up 18% to $3.618 billion.
- Financial Services net income for Q3 was $219 million, with full-year outlook raised to $870 million.


### Outlook and guidance

- Fiscal 2026 net income outlook raised to $4.75–$5 billion; equipment operations cash flow forecast improved to $5–$5.5 billion.
- Production & Precision Ag net sales expected to be down ~10% for the year, with operating margin narrowed to 11–12%.
- Small Ag & Turf net sales expected up ~15% for the year, with operating margin increased to 14.5–15.5%.
- Construction & Forestry net sales forecast up ~20% for the year, with operating margin tightened to 10.5–11.5%.


### Segment performance

- Production & Precision Ag: Lower shipment volumes and higher production costs led to a 6% sales decline; positive price realization and currency effects partially offset declines.
- Small Ag & Turf: 12% sales growth driven by higher volumes and favorable pricing; operating margin at 18.4%.
- Construction & Forestry: 18% sales growth, 12.1% operating margin, supported by strong demand in infrastructure and rental markets.
- Financial Services: Q3 net income up due to favorable financing spreads, despite a lower average portfolio.


### Key financial ratios and metrics

- Q3 equipment operations operating margin: 14.4%.
- Production & Precision Ag operating margin: 13.2%.
- Small Ag & Turf operating margin: 18.4%.
- Construction & Forestry operating margin: 12.1%.
- Effective tax rate guidance: 24–26%.


### Risk factors and uncertainties

- Fluctuating commodity prices, elevated input costs, and uncertain crop demand impacting ag equipment demand.
- Tariff expenses expected at $1.1 billion for the year, with changes in Section 232 tariffs providing some relief; net tariff exposure to increase in 2027.
- Regional market softness in South America and Europe, with cautious outlook for ag equipment recovery.


### Significant events and developments

- Recognized $110 million in incremental tariff refunds in Q3, totaling $382 million for fiscal 2026.
- Launched Deere-designed excavators, with positive early customer feedback and further rollouts planned.
- Increased adoption of precision ag and construction technologies, including SmartGrade and See & Spray.
- FTC settlement formalized right-to-repair tools, supporting lifecycle solutions business.


### Capital allocation and financing

- Improved cash flow expectations for equipment operations to $5–$5.5 billion.
- Continued investment in technology and digital solutions across segments.


### Market and industry conditions

- Large ag equipment industry sales in U.S. and Canada expected to decline 15–20% year-over-year; small ag and turf stable to up 5%.
- Construction equipment industry in U.S. and Canada forecast up 5–10%, driven by infrastructure and rental demand.
- Global forestry industry expected down 10% due to subdued residential construction and softer lumber prices.
- South America ag equipment industry outlook down 15–20%; Asia expected flat.
...
Yeah. Thanks for the question, Rob. I would say if we kind of quickly walk around some of the geography and starting with your questions in on 8R. I would say, 8R orders right now are as expected. Keep in mind, we have orders kind of being 4-5 months out. Our model year 2026 shipment schedule is basically closed. So we are kind of collecting orders here for the first quarter. I think we are encouraged by the recent changes and development in commodity prices specifically. If you look today, we are talking corn futures about $5.05, which is definitely, call it a good signal for a lot of these growers out there. In other geographies, you touched on Europe a little bit and Brazil. In Brazil, we typically take a 3-month order book, kind of to manage the volatility in that market. We have orders for our fourth quarter on hand, and you have seen us change our industry guide given the circumstances we see there. But I think it is too early to tell for how we kind of enter 2027. Certainly, the Move Agriculture financing program Deanna mentioned at single-digit financing rates. Hopefully, that drives some momentum here as we enter 2027. I think in Europe it is a little bit of a mixed picture. That region has a solid Small Ag & Turf, but also PPA exposure. Certainly, arable farmers are a little more challenged right now, and Small Ag & Turf producers still benefiting from dairy and livestock cash flows, which are relatively strong and stable. So more to come on that front. But I would say overall order pace is currently as expected, and we haven't seen a step-up here in the last one or two days or so. Thanks for the question, Rob.
...
Oh, great. Thanks. Congrats on the good execution in a challenging environment. Just maybe to clarify the tariff dynamics. You mentioned there's still some benefit from 232 to come in 2027, because it was only really kind of a half year of benefit this year, and sounds like you have no other refunds embedded in Q4. So really just trying to think about when all is said and done, and comparing 2026 to 2027, is that roughly $800 million net impact that you have this year, and if all else were to be equal, would that be a headwind going into next year or a tailwind or neutral? I know all else is not going to be equal because you already have sounds like some higher plans in large Ag. Just kind of curious, trying to think about headwind or tailwind on that net tariff impact for 2027. Thanks.

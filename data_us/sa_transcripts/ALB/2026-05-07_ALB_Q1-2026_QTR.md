...
title: "Albemarle Corporation Q1 2026 Earnings Call Transcript"
published: 2026-05-07
quarter: "Q1 2026"
event_id: 555822
source: stockanalysis
source_url: https://stockanalysis.com/stocks/alb/transcripts/555822-q1-2026/
audio_url: https://files.quartr.com/audio-files/80c22-2026-05-07-13-28-13.mpeg?ref=U0E=
---

# Albemarle Corporation — Q1 2026 (2026-05-07)

## 요약(stockanalysis 자동 생성)

### Executive summary

- Net sales reached $1.4 billion in Q1 2026, up 33% year-over-year, driven by higher pricing and volumes in both energy storage and specialties.
- Adjusted EBITDA more than doubled to $664 million, reflecting strong market demand and operational improvements.
- The company remains focused on operational excellence, cost discipline, and cash generation to support long-term growth.
- Divestitures of Eurecat JV and Ketjen stake enabled $1.3 billion in debt repayment, strengthening the balance sheet.


### Financial highlights

- Adjusted EBITDA margin increased by over 20 percentage points year-over-year due to higher pricing and productivity gains.
...
- 2026 specialties net sales guidance raised to $1.3–$1.5 billion, with adjusted EBITDA outlook of $225–$275 million.
- Energy storage outlook maintained, with volume guidance unchanged despite geopolitical and supply chain disruptions.
- Full-year cost and productivity improvements targeted at $100–$150 million, with $40 million achieved year-to-date.
- EBITDA margin for specialties expected in the high teens.


### Segment performance

- Energy storage: Q1 sales volumes were 53,000 tons LCE, with average realized price ~$17/kg; net sales up 70% and adjusted EBITDA nearly tripled year-over-year.
- Specialties: Net sales up 12% and adjusted EBITDA up 30% year-over-year, driven by higher pricing and favorable product mix.
- Energy storage EBITDA margin benefited from lower-cost spodumene inventory; margin expected to normalize as the year progresses.


### Key financial ratios and metrics

- Net debt to EBITDA leverage ratio at 1x at quarter-end.
- Weighted average interest rate reduced to 3.1% after debt repayment.
- Operating cash flow conversion expected at 60–70% for the year at $20/kg lithium price scenario.


### Risk factors and uncertainties

- Geopolitical tensions in the Middle East causing supply chain disruptions, with estimated unmitigated cost impact of $70–$90 million for the year.
- Volatility in end markets such as petrochemicals and oil & gas due to global uncertainties.
- Uncertainty in the second half of the year for specialties segment due to global events.


### Significant events and developments

- Successful divestitures and debt repayment actions improved financial flexibility.
- Operations at Jordan Bromine Company JV fully recovered from late 2025 flooding.
- Environmental permitting initiated for commercial DLE project at Salar de Atacama; Kings Mountain project received federal mining permits.
- Productivity improvements identified at Wodgina and Greenbushes JVs, with no major disruptions from global fuel supply issues.


### Capital allocation and financing

- $1.3 billion of debt repaid in Q1, reducing annual interest expense by ~$60 million.
- No major debt maturities until late 2028, providing substantial financial flexibility.


### Market and industry conditions

- Lithium demand up 37% year-to-date, tracking at the upper end of the 2026 forecast range.
- Energy storage sector growth offsetting weaker EV sales; global EV sales up 3% YoY on a GWh basis despite a 6% drop in unit sales.
- Developing markets (Brazil, India, Australia) saw 74% YoY EV growth; European EV sales robust due to policy support.
- Bromine prices in China peaked but have since eased; only a small portion of sales exposed to spot index.
...
Hi, good morning. It's Chris Perrella on for Josh. Can you unpack the puts and takes to the 1Q energy storage margin? You know, given the $20 /kg spot price you guys experienced in the first quarter, I would've thought margins would be closer to 50%, but just kind of, you know, why were they so much better?

**Neal Sheorey**  
*CFO / Albemarle*

Hi, Chris. This is Neal. Sure, I can take that. Really, the main driver of that is the traditional lag that we see in spodumene cost and how we consume spodumene through our supply chain. Really there was a small uplift in margin because essentially we're consuming spodumene that we purchased from our mines in the fourth quarter, which was obviously a lower price than what you saw in the first quarter. You know, it's minimal. I think you see that our full year outlook, if you assume kind of flat pricing across the year, we've guided to energy storage potentially being in that mid 50% range. There was a little bit of an uplift in the 1st quarter due to that, obviously that will start to normalize as we go through the year, assuming pricing stays consistent for the rest of the year. That's why we gave you guidance that we expect margins to come in a little bit in the second quarter as, you know, all things being equal, assuming that that normalizes.
...
Yeah. John, this is Neal. Look, I mean, I guess that's a, there's a lot of estimating and forecasting to get to that number. Look, if you, I'm sure you're doing this math on your side. If you just take flat pricing from where we are today and just run that across the end of the year, you know, we exited first quarter at 1x net debt to EBITDA, and you can imagine that at these kind of prices, we'll probably trend down from there, below 1x . Obviously, like I had said before, you know, our stance right now is to be in a little bit more conservative balance sheet position and, you know, for all the volatility and uncertainty that we see in the world and, that's our posture for the year.
...
Our next question comes from Mazahir Mammadli from Rothschild. Your line is now open.

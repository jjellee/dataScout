...
title: "Oracle Corporation Q1 2027 Earnings Call Transcript"
published: 2026-09-10
quarter: "Q1 2027"
event_id: 689425
source: stockanalysis
source_url: https://stockanalysis.com/stocks/orcl/transcripts/689425-q1-2027/
audio_url: https://files.quartr.com/audio-files/34cbe813084e2003a0607a078f3c1e89-2026-09-10-21-55-40.mpeg?ref=U0E=
---

# Oracle Corporation — Q1 2027 (2026-09-10)

## 요약(stockanalysis 자동 생성)

### Executive summary

- Q1 FY27 saw record revenue of $19.3B, up 30% year-over-year, with sequential growth for the first time in Q1, driven by strong performance in both cloud infrastructure and cloud applications.
- Cloud infrastructure revenue surged 121% year-over-year to $7.4B, while cloud apps grew 10%, with Fusion and industry apps outpacing overall SaaS growth.
- Non-GAAP operating income rose 31% to $8.2B, and non-GAAP EPS increased 30% to $1.92.
- Remaining Performance Obligations (RPO) increased by $26B from Q4, with strong conversion of RPO into revenue, supporting future growth.


### Financial highlights

- Record cash flow from operations reached $23B in Q1, reflecting strong execution and customer prepayments.
- CapEx for the quarter was $28B, resulting in negative free cash flow of $5B; net cash CapEx was $18B.
- Completed $20B at-the-market equity issuance during Q1.
- Operating margin remained flat at 42% on a non-GAAP basis.


### Outlook and guidance

- Q2 FY27 revenue growth expected between 30%-34% year-over-year; cloud revenue growth projected at 65%-71%.
- Non-GAAP EPS guidance for Q2 is $1.85-$1.93, up 21%-25% year-over-year, excluding prior year Ampere gains.
- Upgraded full-year guidance to at least $90B in total revenue (+34% YoY) and $8.10 non-GAAP EPS.
- CapEx for FY27 anticipated at $90B-$95B, with net cash CapEx not exceeding $70B.


### Segment performance

- SaaS business grew 10% overall, with Fusion up 14% and industry applications exceeding 20% growth.
- NetSuite growth lagged due to slower decision cycles but launched NetSuite Next, an AI-powered offering.
- Embedded AI usage in Fusion applications grew 42% sequentially, with 2,300+ AI agents in production, up 90% quarter-over-quarter.
- Cloud infrastructure delivered 850MW of AI capacity, nearly triple Q4, with GPU utilization at 97.9%.
- Multicloud database revenue grew 353% year-over-year; multicloud customers up 180%.


### Key financial ratios and metrics

- Non-GAAP operating margin: 42%.
- Non-GAAP EPS: $1.92, up 30% year-over-year.
- Cash flow from operations: $23B.
- CapEx: $28B; net cash CapEx: $18B.
- RPO up $26B from Q4; about half expected to convert to sales over next 36 months.


### Risk factors and uncertainties

- Gross margin declined due to ramping up data centers and infrastructure revenue acceleration, but offset by lower operating costs and efficiency actions.
- Management expects gross margin to flatten after ramp-up, with operating margin as the key value driver.
- Data center construction and power generation present logistical challenges, but diversified site development and phased delivery mitigate risks.


### Significant events and developments

- Completed $20B equity issuance.
- Announced general availability of NetSuite Next and NetSuite AI Connector Service, with rapid customer adoption.
- Launched new AI and quantum computing partnerships, including with Quantinuum and OpenAI.
- Expanded multicloud database regions to 70 and availability zones to 119.


### Capital allocation and financing

- CapEx for Q1 was $28B, with net cash CapEx at $18B; full-year CapEx guidance $90B-$95B.
- Completed $20B at-the-market equity issuance.
- Multiple funding models for infrastructure growth, including customer prepayments and bring-your-own-hardware, reducing Oracle's direct cash outlay.


### Market and industry conditions

- Strong demand for AI infrastructure and cloud services, with capacity renewals at 20% premium.
- Component and data center costs rising, but pricing power and demand support margin stability.
- SaaS and IaaS businesses mutually reinforcing, with SaaS driving IaaS adoption.
- No anticipated impact from New Mexico and Wisconsin data center timelines on FY27 revenue guidance.

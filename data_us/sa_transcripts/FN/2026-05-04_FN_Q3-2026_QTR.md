...
ticker: FN
company: "Fabrinet"
title: "Fabrinet Q3 2026 Earnings Call Transcript"
published: 2026-05-04
quarter: "Q3 2026"
event_id: 550433
source: stockanalysis
source_url: https://stockanalysis.com/stocks/fn/transcripts/550433-q3-2026/
audio_url: https://files.quartr.com/audio-files/2a850-2026-05-04-22-04-02.mpeg?ref=U0E=
---

# Fabrinet — Q3 2026 (2026-05-04)

## 요약(stockanalysis 자동 생성)

### Executive summary

- Achieved record Q3 revenue of $1.214 billion, up 39% year-over-year and 7% sequentially, surpassing guidance.
- Non-GAAP EPS reached a record $3.72, exceeding guidance, driven by strong execution and FX tailwinds.
- Growth was broad-based across Optical Communications, Telecom, Datacom, and Non-Optical segments.
- Multiple new Datacom programs with hyperscale and merchant customers began shipping, with significant ramp expected in FY27.
- Strategic investments and capacity expansions position the company for continued growth into FY27.


### Financial highlights

- Q3 revenue: $1.214 billion (+39% YoY, +7% QoQ); Optical Communications revenue: $889 million (+35% YoY, +7% QoQ).
- Telecom revenue: $628 million (+55% YoY, +13% QoQ); DCI modules: $197 million (+90% YoY, +38% QoQ).
- Datacom revenue: $260 million (+4% YoY, -6% QoQ) due to component supply constraints.
- Non-Optical Communications revenue: $326 million (+52% YoY, +8% QoQ); HPC revenue: $107 million (+25% QoQ).
- Gross margin: 12.1% (+10bps YoY, -30bps QoQ); operating margin: 10.7% (+50bps YoY, -20bps QoQ).
- Net income: $135 million; operating cash flow: $53 million; free cash flow: -$11 million due to capex.


### Outlook and guidance

- Q4 revenue expected between $1.25–$1.29 billion, ~40% YoY growth at midpoint.
- Non-GAAP EPS guidance: $3.72–$3.87; gross margin dynamics to remain similar to Q3.
- Datacom growth to be more measured in Q4 due to ongoing supply constraints, but new programs to contribute meaningfully in FY27.


### Segment performance

- Telecom: Exceptional growth, especially in DCI modules; 800G ZR ramping with strong future prospects.
- Datacom: Demand outpaces supply; new hyperscale and merchant programs started shipping, with significant ramp expected.
- Non-Optical: HPC revenue ramping, with additional program wins and capacity expansion; Industrial Laser up 9% YoY and 7% QoQ.
- Automotive revenue declined modestly QoQ, offset by other segment growth.


### Key financial ratios and metrics

- Gross margin: 12.1%; operating margin: 10.7%; effective GAAP tax rate: 6.7%.
- Operating expenses: 1.4% of revenue, reflecting strong operating leverage.
- Cash and short-term investments: $946 million; capex: $64 million in Q3.


### Risk factors and uncertainties

- Ongoing supply constraints for Datacom components, including lasers, memory, and ASICs, expected to persist into Q4.
- FX headwinds impacting gross margin.
- Forward-looking statements subject to risks as detailed in SEC filings.


### Significant events and developments

- Minority investment in Raytek Semiconductor ($32 million for 14% stake) to advance CPO manufacturing capabilities.
- Acquisition of Navanakorn facility in Thailand for $11 million, adding 200,000 sq ft and future expansion potential.
- Accelerated construction of Building 10, adding 2 million sq ft, with phased completion through January.
- Share repurchase program remains active with $169 million authorization remaining.


### Capital allocation and financing

- Capex focused on capacity expansion (Building 10, Pinehurst, Navanakorn) to support growth.
- Strong balance sheet enables efficient capital deployment and continued shareholder returns.


### Market and industry conditions

- Explosive demand in AI-driven Datacom and Telecom markets; supply chain lagging demand.
- Strong customer engagement and new program wins across hyperscale, merchant, and OEM customers.
- Industry-wide memory and component shortages impacting near-term shipments.
...
Yeah, there's. Hi, this is Seamus. Yeah, there's a number of, I guess, commodities you could say that are causing us constraints. You know, first of all, we're, you know, very excited at the breadth and depth of the opportunities we see in front of us, not just with our main customer, but across a number of, new products, new markets for us. Since we started to see the revenue accelerate from this AI-driven demand, you know, our strategy has been to support the existing demand and also while pursuing additional hyperscale direct and also merchant relationships. We're excited with the progress we're making there, and what we're managing right now. It's not demand risk, it's, you know, supply constraints. We, with respect to Datacom supply, we saw a broadening of supply shortages for components and materials for Datacom products. As a result, shipments and revenue were, you know, well below demand levels. We, you know, we could have shipped a lot more if we had those components. You know, without these supply constraints, Datacom revenue would have been a new record by a wide margin. We expect the constraints to get resolved over time, we do have to deal with them right now. In the near term, we anticipate that supply volatility will continue. You know, it's in a number of areas. It's not any one component. It's a number of areas, mainly lasers, memory, which I think is, it's no secret that there's a global shortage of memory, and also certain ASICs. It's across a number of commodities.
...
Thank you. Our next question comes from Samik Chatterjee from JP Morgan. Your line is open.
...
Thank you. Our next question will come from Ryan Koontz from Needham & Co. Your line is open.
...
Thank you. Seamus, in talking about the direct hyperscale Datacom business, I think you mentioned that there's two products. Can I ask, does that imply an 800G and a 1.6 or are they two 800G products? Can you, can you comment on that?
...
Thank you. As a reminder, to ask a question, please press star one one. Our next question will come from Tim Savageaux from Northland Capital Markets. Your line is open.

...
title: "Dell Technologies Inc. Q2 2027 Earnings Call Transcript"
published: 2026-09-01
quarter: "Q2 2027"
event_id: 589603
source: stockanalysis
source_url: https://stockanalysis.com/stocks/dell/transcripts/589603-q2-2027/
audio_url: https://files.quartr.com/audio-files/b406520266f59f22d72f7c6a5bc4d910-2026-09-01-22-44-25.mpeg?ref=U0E=
---

# Dell Technologies Inc. — Q2 2027 (2026-09-01)

## 요약(stockanalysis 자동 생성)

### Executive summary

- Achieved record quarterly revenue of $47 billion, up 58% year-over-year, and record EPS of $7.04, up 203%.
- Strong execution across all business segments, driven by infrastructure modernization and AI adoption.
- Booked $60.9 billion in AI server orders this quarter, with a record $95 billion AI backlog.
- Raised full-year revenue guidance by $25 billion to $192 billion, with EPS guidance of $25.50.


### Financial highlights

- Gross margin dollars grew 78% to $9.9 billion; gross margin rate was 21.1%.
- Operating income rose 160% to $5.9 billion (12.6% of revenue); net income up 189% to $4.6 billion.
- Cash flow from operations was $2.2 billion; adjusted free cash flow reached $8.1 billion.
- Returned a record $4.3 billion to shareholders, including share repurchases and dividends.


### Outlook and guidance

- Q3 revenue expected at $49 billion, up ~80% year-over-year; ISG to grow ~145%, CSG up ~15%.
- Full-year revenue guidance raised to $192 billion, up ~70%; diluted non-GAAP EPS of $25.50, up ~150%.
- Operating expenses to be approximately 8% of revenue, the lowest in company history.


### Segment performance

- ISG revenue reached $31.8 billion, up 89%; operating income $4.8 billion, up 225%.
- AI server revenue was $16.4 billion; traditional server and networking revenue up 122% to $10.5 billion.
- Storage revenue up 26% to $4.9 billion, with Dell IP storage demand outpacing the market for six consecutive quarters.
- CSG revenue up 20% to $15 billion; commercial revenue up 22%, consumer revenue up 7%.


### Key financial ratios and metrics

- Gross margin rate: 21.1%.
- Operating income margin: 12.6%.
- ISG operating margin: 15%, up 620 basis points.
- Core leverage ratio: 0.8x.


### Risk factors and uncertainties

- Supply constraints persist across DRAM, NAND, CPUs, disk drives, and other components.
- Demand continues to outpace supply, particularly in traditional servers and AI infrastructure.
- Forward-looking statements subject to risks and uncertainties as detailed in SEC filings.


### Significant events and developments

- Became first to ship rack systems engineered on NVIDIA Vera Rubin platform.
- Over 6,500 customers now buying AI Factory solutions, with rapid acceleration in enterprise adoption.
- Project Lightning, a parallel file system for AI, is in beta at several customers.


### Capital allocation and financing

- Ended quarter with $14.2 billion in cash and investments.
- Repurchased 9.5 million shares at an average price of $401 per share.
- Paid a dividend of $0.63 per share.
- Positive credit rating actions during the quarter.


### Market and industry conditions

- Structural growth in infrastructure demand driven by data center modernization and AI adoption.
- AI expected to be 75% of all data center demand by 2030, with enterprise agentic workloads as the largest segment by 2028.
- Storage growth fueled by unstructured data, compliance, and AI-driven workloads.
...
**Paul Frantz**  
*Head of Investor Relations / Dell Technologies*
...
Thank you. Our first question comes from Amit Daryanani with Evercore.
...
Ben, maybe some more context around that. Our five-quarter pipeline grew sequentially. That's after booking $131.7 billion of orders over the past four quarters. I think that gives you a sense of what's happening today. If I look at the longer-term trends, I know you're a believer of this, but as we see it, agentic demand is reshaping the data center and the underlying infrastructure. Inference is past training and is pure demand on our industry. We think the tokens that inference drives is going to grow 87x to 3,600 quadrillion tokens by 2030. Training demand grows 5x to 850 zettaflops by 2030. Enterprise agentic is expected to be the single largest workload by 2028. We're expecting AI to be 75% of all data center demand by 2030, adding 200 GW of power over that same timeframe, and half of that, we believe, is right in our sweet spot with our customers, the Neocloud sovereigns and enterprises. If you look at that math, we think the opportunity in front of us is more than a trillion dollars over that timeframe. We believe we're well-positioned. We believe that our model is differentiated, that our engineering is differentiating ourselves with every customer that we interact with. The scale of our deployment capabilities is unmatched globally. We believe what we're doing on the support side is equally important, helping customers ramp getting to that first token faster than anyone else, and then keeping it running. The DFS component that we have to help customers in that bridge point from an order to that first token is something that we believe is differentiating us, and we're going to continue to focus on that. If you believe that demand is there, it drives more servers in the agentic workload, and it drives more data around that agentic workload, growing each of those areas for us as well.
...
And we'll take a question from Ca.
...
Hi, guys. This is Michael Tsvetkov on behalf of Aaron. Thanks so much for letting me ask the question. I wanted to ask on the storage business, obviously very strong. Within that, you mentioned several solidly performing Dell IP portfolio products. One of which I wanted to ask about is Project Lightning. How is that contributing at this point, and what level of attach are you seeing to those cloud AI server deals?

**Jeff Clarke**  
*Vice Chairman and COO / Dell Technologies*

For Project Lightning, our parallel file system. There's an echo, sorry. Parallel file system designed for native AI use cases. We continue to have the product out in the field. We continue to see interest. It's still a relatively new product. It's in beta at several customers. We're in runoffs against other competitors with the product. That will continue, and as it builds momentum, I'm certain we'll give you an update in the future. But that's where Project Lightning is at the moment. Thank you.
...
Thank you. That does conclude today's conference with you. Thank you for your participation, and have an excellent day.
